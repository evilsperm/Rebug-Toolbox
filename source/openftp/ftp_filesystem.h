...
LV2_SYSCALL lv2FsRead(Lv2FsFile fd, void* buf, u64 size, u64* read_e) { return Lv2Syscall4(802, fd, (u64)buf, size, (u64)read_e); }
...
LV2_SYSCALL lv2FsReadDir(Lv2FsFile fd, Lv2FsDirent* entry, u64* read_e) { return Lv2Syscall3(806, fd, (u64)entry, (u64)read_e); }
